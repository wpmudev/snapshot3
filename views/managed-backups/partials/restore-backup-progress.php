            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div id="wps-build-error" class="hidden">
                        ...
                        <p>
                            <a href="<?php echo esc_url( WPMUDEVSnapshot::instance()->snapshot_get_pagehook_url( 'snapshots-newui-managed-backups' ) ); ?>" id="wps-build-error-again" class="button button-gray"><?php esc_html_e('Try Again', SNAPSHOT_I18N_DOMAIN); ?></a>
                    ...
                    <div id="wps-build-progress">
                       ...
                       <div id="wps-build-progress-container">
                            ...
                            <div class="wpmud-box-gray">
                                ...
                                <div class="wps-loading-status wps-total-status wps-spinner">
                                    ...
                                    <div class="cancel-progress">
                                        <i id="wps-cancel" class="wps-icon i-close"></i>
                                    </div>
                                </div>
                                <div class="progress-action-title"></div>
                            </div>
                       </div>
                        <div id="wps-build-success" class="hidden">
                            ...
                            <div class="wps-auth-message success">
                                ...
                                <p>
				                    <?php echo wp_kses_post( sprintf( __( 'Your website has been successfully restored! <a href="%s">View website</a>.', SNAPSHOT_I18N_DOMAIN ), esc_url( get_site_url() ) ) ); ?>
                                </p>
                        ...
                        <div id="wps-log" class="hidden">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr id="wps-log-process-init">
                                    ...
                                    <td class="wps-log-process"><?php esc_html_e('Determining tables & files to restore', SNAPSHOT_I18N_DOMAIN); ?></td>
                                ...
                                <tr id="wps-log-process-fileset">

                                        <td class="wps-log-process"><?php esc_html_e('Files', SNAPSHOT_I18N_DOMAIN); ?></td>
                                ...
                                <tr id="wps-log-process-tableset">

                                    <td class="wps-log-process"><?php esc_html_e('Database', SNAPSHOT_I18N_DOMAIN); ?></td>
                                ...
                                <tr id="wps-log-process-finish" >
                                    ...
                                    <td class="wps-log-process"><?php esc_html_e('Finalize restoration', SNAPSHOT_I18N_DOMAIN); ?></td>
