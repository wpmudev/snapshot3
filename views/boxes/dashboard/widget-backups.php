					...
					<?php if ( true === ! $is_client ) : ?>
						...
						<div class="wps-cta-box">
							...
							<div class="wps-cta">
								...
								<div class="wps-cta-text"><?php echo wp_kses_post( __( 'A WPMU DEV membership features automated incremental backups, with 10GB of included cloud storage and 24/7 support – <strong><a href="https://premium.wpmudev.org/project/snapshot/?utm_source=snapshot&utm_medium=plugin-dashboard&utm_campaign=snapshot-plugin-project" target="_blank" class="snapshot-try-free">Try it all absolutely FREE</a></strong>' , SNAPSHOT_I18N_DOMAIN ) ); ?></div>
